...
function getCustomInitConfig(): InitConfig {
  const configs: (InitPackage | InitCommand | InitFile)[] = [
    ...STEAM_CMD_INIT,
    ...setUpShellScript(
      '/opt/minecloud/server/ValheimServer',
    ...
    ...setUpShellScript(
      ...
      'InstallUpdate.sh',
      'minecloud_configs/advanced_configs/InstallUpdate.sh'
    ),
    InitCommand.shellCommand(
      `chown -R ec2-user:ec2-user ${MINECLOUD_SERVER_DIR}`,
      {
